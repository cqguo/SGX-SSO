...
\begin{itemize}
\item {\noindent\textbf{Hiding RP Identities from the IdP.}} SPRESSO~\cite{SPRESSO} was proposed to protect user privacy against the IdP by hiding RP identities. It uses the encrypted RP ID instead, and IdP issues the identity proof for this one-time encrypted ID.
...
To be noticed is that the user-side service must be deployed at the user-controlled and IdP trusted environment, i.e., Intel SGX in this paper.
